...
UniValue omni_getfeedistribution(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getfeedistribution", "1") + HelpExampleRpc("omni_getfeedistribution", "1"));
...
UniValue omni_getfeedistributions(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getfeedistributions", "1") + HelpExampleRpc("omni_getfeedistributions", "1"));
...
UniValue omni_getfeetrigger(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getfeetrigger", "3") + HelpExampleRpc("omni_getfeetrigger", "3"));
...
UniValue omni_getfeeshare(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 2)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getfeeshare", "\"1EXoDusjGwvnjZUyKkxZ4UHEf77z6A5S4P\" 1") + HelpExampleRpc("omni_getfeeshare", "\"1EXoDusjGwvnjZUyKkxZ4UHEf77z6A5S4P\", 1"));
...
UniValue omni_getfeecache(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getfeecache", "31") + HelpExampleRpc("omni_getfeecache", "31"));
...
UniValue omni_getseedblocks(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getseedblocks", "290000 300000") + HelpExampleRpc("omni_getseedblocks", "290000, 300000"));
...
UniValue omni_getpayload(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getpayload", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\"") + HelpExampleRpc("omni_getpayload", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\""));
    ...
    if (parseRC < 0)
        PopulateFailure(MP_TX_IS_NOT_MASTER_PROTOCOL);
...
UniValue mscrpc(const UniValue& params, bool fHelp)
{
    ...
    if (0 < params.size())
        extra = atoi(params[0].get_str());
    if (1 < params.size())
        extra2 = atoi(params[1].get_str());
    if (2 < params.size())
        extra3 = atoi(params[2].get_str());
...
UniValue omni_getbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getbalance", "\"1EXoDusjGwvnjZUyKkxZ4UHEf77z6A5S4P\" 1") + HelpExampleRpc("omni_getbalance", "\"1EXoDusjGwvnjZUyKkxZ4UHEf77z6A5S4P\", 1"));
...
UniValue omni_getallbalancesforid(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getallbalancesforid", "1") + HelpExampleRpc("omni_getallbalancesforid", "1"));
...
UniValue omni_getallbalancesforaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getallbalancesforaddress", "\"1EXoDusjGwvnjZUyKkxZ4UHEf77z6A5S4P\"") + HelpExampleRpc("omni_getallbalancesforaddress", "\"1EXoDusjGwvnjZUyKkxZ4UHEf77z6A5S4P\""));
...
UniValue omni_getwalletbalances(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getwalletbalances", "") + HelpExampleRpc("omni_getwalletbalances", ""));
...
UniValue omni_getwalletaddressbalances(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getwalletaddressbalances", "") + HelpExampleRpc("omni_getwalletaddressbalances", ""));
...
UniValue omni_getproperty(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getproperty", "3") + HelpExampleRpc("omni_getproperty", "3"));
...
UniValue omni_listproperties(const UniValue& params, bool fHelp)
{
    if (fHelp)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_listproperties", "") + HelpExampleRpc("omni_listproperties", ""));
...
UniValue omni_getcrowdsale(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getcrowdsale", "3 true") + HelpExampleRpc("omni_getcrowdsale", "3, true"));
    ...
    if (sp.close_early)
        response.push_back(Pair("endedtime", sp.timeclosed));
    if (sp.close_early && !sp.max_tokens)
        response.push_back(Pair("closetx", txidClosed));
...
UniValue omni_getactivecrowdsales(const UniValue& params, bool fHelp)
{
    if (fHelp)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getactivecrowdsales", "") + HelpExampleRpc("omni_getactivecrowdsales", ""));
...
UniValue omni_getgrants(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getgrants", "31") + HelpExampleRpc("omni_getgrants", "31"));
...
UniValue omni_getorderbook(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getorderbook", "2") + HelpExampleRpc("omni_getorderbook", "2"));
...
UniValue omni_gettradehistoryforaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("omni_gettradehistoryforaddress", "\"1MCHESTptvd2LnNp7wmr2sGTpRomteAkq8\"") + HelpExampleRpc("omni_gettradehistoryforaddress", "\"1MCHESTptvd2LnNp7wmr2sGTpRomteAkq8\""));
...
UniValue omni_gettradehistoryforpair(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_gettradehistoryforpair", "1 12 500") + HelpExampleRpc("omni_gettradehistoryforpair", "1, 12, 500"));
...
UniValue omni_getactivedexsells(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getactivedexsells", "") + HelpExampleRpc("omni_getactivedexsells", ""));
    ...
    for (OfferMap::iterator it = my_offers.begin(); it != my_offers.end(); ++it) {
        ...
        // filtering
        if (!addressFilter.empty() && seller != addressFilter)
            continue;
...
UniValue omni_listblocktransactions(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("omni_listblocktransactions", "279007") + HelpExampleRpc("omni_listblocktransactions", "279007"));
...
UniValue omni_gettransaction(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nbExamples:\n" +
            HelpExampleCli("omni_gettransaction", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\"") + HelpExampleRpc("omni_gettransaction", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\""));
    ...
    if (populateResult != 0)
        PopulateFailure(populateResult);
...
UniValue omni_listtransactions(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 5)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_listtransactions", "") + HelpExampleRpc("omni_listtransactions", ""));
...
UniValue omni_listpendingtransactions(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_listpendingtransactions", "") + HelpExampleRpc("omni_listpendingtransactions", ""));
...
UniValue omni_getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getinfo", "") + HelpExampleRpc("omni_getinfo", ""));
...
UniValue omni_getactivations(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getactivations", "") + HelpExampleRpc("omni_getactivations", ""));
...
UniValue omni_getsto(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_getsto", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\" \"*\"") + HelpExampleRpc("omni_getsto", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\", \"*\""));

    uint256 hash = ParseHashV(params[0], "txid");
    std::string filterAddress;
    if (params.size() > 1)
        filterAddress = ParseAddressOrWildcard(params[1]);
...
UniValue omni_gettrade(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "The documentation only covers the output for a trade, but there are also cancel transactions with different properties.\n"
            "\nExamples:\n" +
            HelpExampleCli("omni_gettrade", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\"") + HelpExampleRpc("omni_gettrade", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\""));
...
UniValue omni_getcurrentconsensushash(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("omni_getcurrentconsensushash", "") + HelpExampleRpc("omni_getcurrentconsensushash", ""));
    ...
    char buf[20] = {0};
    _itoa(block, buf, 10);
    std::string hash = FuncCallbackChar(CBINDEX_GETHASH, buf);
    ...
    UniValue response(UniValue::VOBJ);
    response.push_back(Pair("block", block));
    response.push_back(Pair("blockhash", hash));
...
UniValue omni_getmetadexhash(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("omni_getmetadexhash", "3") + HelpExampleRpc("omni_getmetadexhash", "3"));
...
UniValue omni_getbalanceshash(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("omni_getbalanceshash", "31") + HelpExampleRpc("omni_getbalanceshash", "31"));
